...
void setup() {
  ...
  server.on("/batimento.png", HTTP_GET, []() {
    File file = SPIFFS.open("/batimento.png", "r");
...
<html><head>
  ...
  <style>
    ...
    .content { margin-left: 80px; padding: 20px; text-align: center; }
...
<div class="content">
  <img src="/batimento.png" alt="Batimento Cardíaco">
